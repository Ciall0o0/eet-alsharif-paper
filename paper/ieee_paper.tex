...
proposed agent improves mean per-episode reward 5.1$\times$ over the best
rule baseline (SD-nearest; pooled Welch $t(13.7) = 8.11$,
$p = 1.4\times10^{-6}$, Cohen's $d = 3.01$; 3 seeds $\times$ 12
episodes, paired per-seed tests all $p < 0.0001$), and Pareto-dominates both
